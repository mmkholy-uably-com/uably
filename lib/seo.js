...
// Contact-form submission endpoint. Point this at a hosted form backend
// (Formspree "https://formspree.io/f/xxxx", Web3Forms "https://api.web3forms.com/submit",
// Getform, Basin, etc.) with NEXT_PUBLIC_FORM_ENDPOINT. Empty = the form falls
// back to opening the visitor's email client (mailto) so leads are never lost.
export const FORM_ENDPOINT = process.env.NEXT_PUBLIC_FORM_ENDPOINT || "";

// Optional public access key some providers require in the request body
// (e.g. Web3Forms). Safe to expose; it only authorizes submissions to your form.
