...
export const alt = "Uably — Conseil TI senior pour entreprises";
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          <div style={{ fontSize: 68, fontWeight: 700, lineHeight: 1.05, letterSpacing: "-0.04em", maxWidth: 900 }}>
            Transformez vos TI. Renforcez la sécurité. Évoluez en confiance.
          </div>
          <div style={{ marginTop: 28, fontSize: 30, color: "#9aa3b8", maxWidth: 940 }}>
            Transformation cloud · ISO 27001 &amp; SOC 2 · ServiceNow GRC · DevSecOps · Everbridge
          </div>
        </div>
        <div style={{ display: "flex", fontSize: 26, color: "#5C8CFF", letterSpacing: "0.04em" }}>
          Calibre Big 4. Zéro structure. — uably.com
        </div>
      </div>
    ),
    { ...size }
